...

{
  ...
  var warnNonPresent = function (target, key) {
    warn(
      ...
      'See: https://vuejs.org/v2/guide/reactivity.htmls#Declaring-Reactive-Properties.',
      target
    );
  };
...
function initData (vm) {
  ...
  if (!isPlainObject(data)) {
    ...
    "development" !== 'production' && warn(
      ...
      'https://vuejs.org/v2/guide/components.htmls#data-Must-Be-a-Function',
      vm
    );
  }
...
function createPatchFunction (backend) {
  ...
  function removeNode (el) {
    ...
    // element may have already been removed due to v-htmls / v-text
    if (isDef(parent)) {
    ...
    if (isDef(tag)) {
      if (isDef(children)) {
        ...
        if (!elm.hasChildNodes()) {
          ...
          // v-htmls and domProps: innerHTML
...
function genFor (
  ...
  if ("development" !== 'production' &&
    ...
    state.warn(
      ...
      "See https://vuejs.org/guide/list.htmls#key for more info.",
      true /* tip */
    );
  }
...
Vue.prototype.$mount = function (
  ...
  if (el === document.body || el === document.documentElement) {
    "development" !== 'production' && warn(
      "Do not mount Vue to <htmls> or <body> - mount to normal elements instead."
    );
    return this
  }
